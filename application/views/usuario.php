...
<!-- 							<ul class="sub-menu">
			...
			<div class="col-md-6 col-md-offset-3">
				...
				<h3 class="font-green"><strong>Referido</strong></h3>
				 <div class="form-group">
					<label class="control-label visible-ie8 visible-ie9">Identificación</label>
					<input class="form-control placeholder-no-fix" type="text" value="<?php echo $usuario['dni']; ?>" readonly />
				</div>
				 <div class="form-group">
					<label class="control-label visible-ie8 visible-ie9">Nombres</label>
					<input class="form-control placeholder-no-fix" type="text" value="<?php echo $usuario['nombre']; ?>" readonly />
				</div>
				<div class="form-group">
					<label class="control-label visible-ie8 visible-ie9">Apellidos</label>
					<input class="form-control placeholder-no-fix" type="text" value="<?php echo $usuario['apellido']; ?>" readonly />
				</div>
				<div class="form-group">
					<label class="control-label visible-ie8 visible-ie9">Correo Electrónico</label>
					<input class="form-control placeholder-no-fix" type="email" value="<?php echo $usuario['correo']; ?>" readonly />
				</div>
				<div class="form-group">
					<label class="control-label visible-ie8 visible-ie9">Usuario</label>
					<input class="form-control placeholder-no-fix" type="text" value="<?php echo $usuario['usuario']; ?>" readonly />
				</div>
			</div>
