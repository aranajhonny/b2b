		...
		<head>
				...
				<link href="<?=base_url();?>assets/layouts/layout4/css/custom.min.css" rel="stylesheet" type="text/css" />
				 <link href="//cdn-images.mailchimp.com/embedcode/slim-081711.css" rel="stylesheet" type="text/css">
   				 ...
   				 <link rel="stylesheet" href="<?=base_url();?>d3/build/build.css">
   				 <link rel="stylesheet" href="<?=base_url();?>d3/index.css">
										...
										<div class="row">
												<div class="col-md-12">
														...
														<div class="portlet light bordered">
															<div id="example">
														      <div id="editme" style="display: none;"></div>
														      <div id="d3view"></div>
    														</div>
														</div>
...
<![endif]-->
				...
				<script src="<?=base_url();?>assets/layouts/global/scripts/quick-sidebar.min.js" type="text/javascript"></script>
				    ...
				    <script src="<?=base_url();?>d3/d3.v3.min.js"></script>
				    <script src="<?=base_url();?>d3/demo-bundle.js"></script>
				    <script src="<?=base_url();?>d3/marked.js"></script>

				    <script src="<?=base_url();?>d3/demo-data.js"></script>
				    <script type="text/javascript">
				    	const flare_data = <?php echo $usuarios; ?>;
				    </script>
				    <!-- <script src="<?=base_url();?>d3/flare-data.js"></script> -->

				    <script src="<?=base_url();?>d3/setup.js"></script>
