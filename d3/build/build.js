            ...
            actions: {
              ...
              toggleCollapse: function(id, yes) {
                ...
                if (arguments.length === 1) {
                  yes =
                    !this.model.ids[id].children.length ||
        ...
        function(_dereq_, module, exports) {
          ...
          LocalPL.prototype = {
            ...
            save: function(type, id, data, done) {
              localStorage[this.prefix + type + ":" + id] = JSON.stringify(
                data
              );
              done && done();
            },
  ...
  */
            ...
            keyHandler: function() {
              ...
              for (action in this.o.keybindings) {
                if (!this.actions[action]) {
                  throw new Error(
                    "Invalid configuration! Unknown action: " + action
                  );
                }
            ...
            makeBlock: function(id, i) {
              ...
              var block = new Block(node, children, config, {
                ...
                saveContent: function(content) {
                  this.ctrl.executeCommands("changeContent", [
                    node.id,
                    content
                  ]);
                }.bind(this),
    ...
    */
            ...
            _onDoubleClick: function(e) {
              ...
              this.ctrl.executeCommands("newNode", [
                this.root,
                idx,
                "",
                {
