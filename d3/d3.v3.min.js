!(function() {
  ...
  function f() {
    for (var n in this) if (n.charCodeAt(0) === ga) return !1;
    return !0;
  }
  function h() {}
  function g(n, t, e) {
  ...
  function F(n, t, e) {
    ...
    function i() {
      var t,
        e = new RegExp("^__on([^.]+)" + Go.requote(n) + "$");
      for (var r in this)
        if ((t = r.match(e))) {
          var u = this[r];
  ...
  function ct(n, t, e) {
    return (
      isNaN(n) && (n = 0),
      isNaN(t) && (t = 0),
      st(e, Math.cos((n *= za)) * t, Math.sin(n) * t)
    );
  }
  function st(n, t, e) {
    return new lt(n, t, e);
  ...
  function ft(n, t, e) {
    ...
    return (
      ...
      (i = gt(i) * $a),
      yt(
        vt(3.2404542 * u - 1.5371385 * r - 0.4985314 * i),
        vt(-0.969266 * u + 1.8760108 * r + 0.041556 * i),
        vt(0.0556434 * u - 0.2040259 * r + 1.0572252 * i)
      )
    );
  }
  function ht(n, t, e) {
    return n > 0
      ? ot(Math.atan2(e, t) * Ra, Math.sqrt(t * t + e * e), n)
      : ot(0 / 0, 0 / 0, n);
  }
  function gt(n) {
  ...
  function wt(n, t, e) {
    ...
    var r = pt((0.4124564 * n + 0.3575761 * t + 0.1804375 * e) / Za),
      u = pt((0.2126729 * n + 0.7151522 * t + 0.072175 * e) / Va),
      i = pt((0.0193339 * n + 0.119192 * t + 0.9503041 * e) / $a);
  ...
  function Ct(n, t, e, r) {
    ...
    var i = {},
      o = Go.dispatch("beforesend", "progress", "load", "error"),
      a = {},
  ...
  function Tt() {
    var n = qt(),
      t = zt() - n;
    t > 24
      ? (isFinite(t) && (clearTimeout(Qa), (Qa = setTimeout(Tt, t))), (Ka = 0))
      : ((Ka = 1), tc(Tt));
  }
  function qt() {
    var n = Date.now();
      ...
      function t(t) {
        for (var e, u, i, o = [], a = -1, c = 0; ++a < r; )
          37 === n.charCodeAt(a) &&
            ...
            null != (u = cc[(e = n.charAt(++a))]) && (e = n.charAt(++a)),
      ...
      var g,
        ...
        y = {
          ...
          polygonEnd: function() {
            ...
            var n = De(m, p);
            g.length
              ? (_ || (i.polygonStart(), (_ = !0)), Ae(g, Re, n, e, i))
              : n &&
  ...
  function Re(n, t) {
    return (
      ((n = n.x)[0] < 0 ? n[1] - La - Ta : La - n[1]) -
      ((t = t.x)[0] < 0 ? t[1] - La - Ta : La - t[1])
    );
  }
  function De(n, t) {
    var e = n[0],
      ...
      if (l)
        for (
          ...
          var m = n[0],
            ...
            k = p * x;
          if (
            (dc.add(Math.atan2(k * b * Math.sin(w), v * M + k * Math.cos(w))),
            (i += S ? _ + b * Ca : _),
            S ^ (h >= e) ^ (m >= e))
          ) {
            var E = de(pe(f), pe(n));
  ...
  function Oe(n, t, e, r) {
    ...
    return function(a) {
      ...
      function g() {
        v && (p(y, x), M && w && N.rejoin(), v.push(N.buffer())),
          (C.point = f),
          w && a.lineEnd();
      }
      function p(n, t) {
    ...
    function u(t, e, r, a, c, s, l, f, h, g, p, v, d, m) {
      ...
      if (M > 4 * i && d--) {
        var _ = a + g,
          ...
          q = x * L - y * T;
        ((q * q) / M > i ||
          fa((y * L + x * T) / M - 0.5) > 0.3 ||
          o > a * g + c * p + s * v) &&
          (u(t, e, r, a, c, s, A, C, E, (_ /= S), (b /= S), w, d, m),
          m.point(A, C),
          u(A, C, E, _, b, w, l, f, h, g, p, v, d, m));
      }
    }
    var i = 0.5,
      o = Math.cos(30 * za),
  ...
  function ir(n) {
    ...
    return (
      ...
      (t.clipAngle = function(n) {
        return arguments.length
          ? ((M = null == n ? ((b = n), Lc) : He((b = +n) * za)), u())
          : b;
      }),
      (t.clipExtent = function(n) {
        return arguments.length
          ? ((w = n),
            (_ = n ? Oe(n[0][0], n[0][1], n[1][0], n[1][1]) : Nt),
            u())
          : w;
      }),
      (t.scale = function(n) {
  ...
  function Ur(n) {
    ...
    for (
      var c = i;
      c.circle && fa(e - c.circle.x) < Ta && fa(r - c.circle.cy) < Ta;
    ...
    for (
      var s = o;
      s.circle && fa(e - s.circle.x) < Ta && fa(r - s.circle.cy) < Ta;
    ...
    (c = a[0]),
      (s = a[f - 1]),
      (s.edge = Wr(c.site, s.site, null, u)),
      Vr(c),
      Vr(s);
  }
  function jr(n) {
    ...
    if ((Gc.insert(t, c), t || e)) {
      ...
      Kr(e.edge, s, p, M),
        (c.edge = Wr(s, n, null, M)),
        (e.edge = Wr(n, p, null, M)),
        Vr(t),
        Vr(e);
    }
  }
  ...
  function $r(n) {
    var t = n.circle;
    t &&
      (t.P || (Kc = t.N), Qc.remove(t), ts.push(t), tu(t), (n.circle = null));
  }
  function Xr(n) {
    for (
      var t, e = Jc, r = Fe(n[0][0], n[0][1], n[1][0], n[1][1]), u = e.length;
      u--;
      ...
      (t = e[u]),
        (!Br(t, n) ||
          !r(t) ||
          (fa(t.a.x - t.b.x) < Ta && fa(t.a.y - t.b.y) < Ta)) &&
  ...
  function Wr(n, t, e, r) {
    ...
    return (
      ...
      e && Kr(u, n, t, e),
      r && Kr(u, t, n, r),
      Wc[n.i].edges.push(new Qr(u, n, t)),
      Wc[t.i].edges.push(new Qr(u, t, n)),
      u
    );
  }
  function Gr(n, t, e) {
  ...
  function iu(n, t) {
    ...
    for (Jc = [], Wc = new Array(n.length), Gc = new nu(), Qc = new nu(); ; )
      if (((u = Kc), i && (!u || i.y < u.y || (i.y === u.y && i.x < u.x))))
        (i.x !== e || i.y !== r) &&
          ((Wc[i.i] = new Or(i)), jr(i), (e = i.x), (r = i.y)),
          (i = n.pop());
      else {
        if (!u) break;
        Ur(u.arc);
      ...
      (u = r.index) > i &&
        ...
        (e = e[0]) === (r = r[0])
          ? a[o]
            ? (a[o] += r)
            : (a[++o] = r)
          : ((a[++o] = null), c.push({ i: o, x: pu(e, r) })),
        (i = us.lastIndex);
    return (
      i < t.length && ((u = t.substring(i)), a[o] ? (a[o] += u) : (a[++o] = u)),
      a.length < 2
        ? c[0]
          ? ((t = c[0].x),
            function(n) {
  ...
  function du(n, t) {
    for (
      var e, r = Go.interpolators.length;
      --r >= 0 && !(e = Go.interpolators[r](n, t));
  ...
  function Du(n) {
    ...
    t[0] * e[1] < e[0] * t[1] &&
      ((t[0] *= -1), (t[1] *= -1), (r *= -1), (u *= -1)),
      (this.rotate =
        (r ? Math.atan2(t[1], t[0]) : Math.atan2(-e[0], e[1])) * Ra),
    ...
    return (
      a[0] != c[0] || a[1] != c[1]
        ? (r.push("translate(", null, ",", null, ")"),
          u.push({ i: 1, x: pu(a[0], c[0]) }, { i: 3, x: pu(a[1], c[1]) }))
        : c[0] || c[1]
        ? r.push("translate(" + c + ")")
        : r.push(""),
      s != l
      ...
      f != h
        ? u.push({ i: r.push(r.pop() + "skewX(", null, ")") - 2, x: pu(f, h) })
  ...
  function Zu(n, t) {
    if (n === t) return n;
    for (
      var e = Yu(n), r = Yu(t), u = e.pop(), i = r.pop(), o = null;
      u === i;
  ...
  function Wu(n, t) {
    return (
      Go.rebind(n, t, "sort", "children", "value"),
      (n.nodes = n),
      (n.links = ni),
      n
    );
      ...
      if (
        ...
        for (
          ...
          if (1 == p)
            for (
              c = r._pack_prev;
              c !== a._pack_prev && !Ei(c, i);
              c = c._pack_prev, d++
            );
          p
            ? (d > v || (v == d && u.r < r.r) ? ki(r, (u = a)) : ki((r = c), u),
              o--)
            : (Si(r, i), (u = i), t(i));
        }
      var m = (l + f) / 2,
  ...
  function Gi(n, t) {
    var e = Wi(t[2]);
    return n in ds
      ? Math.abs(e - Wi(Math.max(fa(t[0]), fa(t[1])))) + +("e" !== n)
      : e - 2 * ("%" === n);
  }
  function Ki(n, t, e, r) {
    function u(n) {
    ...
    return (
      ...
      (o.tickFormat = function(n, t) {
        ...
        arguments.length < 2
          ? (t = ms)
          : "function" != typeof t && (t = Go.format(t));
        var r,
  ...
  function Qi(n, t, e) {
    ...
    return (
      ...
      (r.exponent = function(o) {
        return arguments.length
          ? ((u = no((t = o))), (i = no(1 / t)), n.domain(e.map(u)), r)
          : t;
      }),
      (r.copy = function() {
    ...
    return (
      ...
      (u.invertExtent = function(n) {
        return (
          ...
          0 > n
            ? [0 / 0, 0 / 0]
            : [n > 0 ? i[n - 1] : t[0], n < i.length ? i[n] : t[t.length - 1]]
        );
      }),
      (u.copy = function() {
        return eo(t, e);
  ...
  function lo(n) {
    function t(t) {
      ...
      for (
        var c, s = [], l = [], f = -1, h = t.length, g = Et(e), p = Et(r);
        ++f < h;
    ...
    return (
      ...
      (t.interpolate = function(n) {
        return arguments.length
          ? ((o = "function" == typeof n ? (i = n) : (i = ks.get(n) || fo).key),
            t)
          : o;
      }),
  ...
  function yo(n, t) {
    return n.length < 3
      ? fo(n)
      : n[0] +
          Mo((n.push(n[0]), n), _o([n[n.length - 2]].concat(n, [n[1]]), t));
  }
  function xo(n, t) {
  ...
  function bo(n) {
    ...
    for (n.push(n[e - 1]); ++t <= e; )
      (r = n[t]), o.shift(), o.push(r[0]), a.shift(), a.push(r[1]), No(c, o, a);
  ...
  function wo(n) {
    ...
    for (e.push(Eo(As, i) + "," + Eo(As, o)), --r; ++r < u; )
      (t = n[r]), i.shift(), i.push(t[0]), o.shift(), o.push(t[1]), No(e, i, o);
    return e.join("");
  }
  function So(n) {
    for (var t, e, r = -1, u = n.length, i = u + 4, o = [], a = []; ++r < 4; )
      (e = n[r % u]), o.push(e[0]), a.push(e[1]);
    for (t = [Eo(As, o), ",", Eo(As, a)], --r; ++r < i; )
      (e = n[r % u]),
        o.shift(),
        o.push(e[0]),
        a.shift(),
  ...
  function Co(n) {
    for (
      ...
      r[t] = (o + (o = Ao((u = i), (i = n[t + 1])))) / 2;
    return (r[t] = o), r;
  }
  function Lo(n) {
    for (var t, e, r, u, i = [], o = Co(n), a = -1, c = n.length - 1; ++a < c; )
      (t = Ao(n[a], n[a + 1])),
        fa(t) < Ta
          ? (o[a] = o[a + 1] = 0)
          : ((e = o[a] / t),
  ...
  function zo(n) {
    ...
    return (
      ...
      (t.interpolate = function(n) {
        return arguments.length
          ? ((c = "function" == typeof n ? (a = n) : (a = ks.get(n) || fo).key),
            (s = a.reverse || a),
            (l = a.closed ? "M" : "L"),
            t)
          : c;
  ...
  (Go.ascending = n),
    ...
    (Go.median = function(e, r) {
      return (
        ...
        (e = e.filter(t)),
        e.length ? Go.quantile(e.sort(n), 0.5) : void 0
      );
    });
  var la = e(n);
  (Go.bisectLeft = la.left),
    (Go.bisect = Go.bisectRight = la.right),
    (Go.bisector = function(t) {
      return e(
        1 === t.length
          ? function(e, r) {
              return n(t(e), r);
    ...
    (_a.selectAll = function(n) {
      ...
      for (var u = -1, i = this.length; ++u < i; )
        for (var o = this[u], a = -1, c = o.length; ++a < c; )
          (e = o[a]) &&
            (r.push((t = Qo(n.call(e, e.__data__, a, u)))), (t.parentNode = e));
      return _(r);
    });
  var ba = {
  ...
  (Go.ns = {
    ...
    qualify: function(n) {
      ...
      return (
        ...
        ba.hasOwnProperty(e) ? { space: ba[e], local: n } : n
      );
    }
  }),
  ...
  var wa = [];
  (Go.selection.enter = U),
    (Go.selection.enter.prototype = wa),
    (wa.append = _a.append),
    (wa.empty = _a.empty),
    (wa.node = _a.node),
    (wa.call = _a.call),
    ...
    (_a.transition = function() {
      for (
        var n,
          ...
          e = Ls || ++Ds,
          r = [],
          u = Ts || { time: Date.now(), ease: wu, delay: 0, duration: 250 },
          i = -1,
          o = this.length;
        ++i < o;
  ...
  (Go.interpolateZoom = function(n, t) {
    ...
    (Go.behavior.zoom = function() {
      ...
      function s() {
        ...
        function e() {
          f.on(A, ea === r ? h : null).on(C, null),
            p(l && Go.event.target === i),
            c(s);
        }
        var r = this,
          i = Go.event.target,
      ...
      function l() {
        ...
        function i() {
          for (
            var n, t, e, i, o = Go.touches(g), c = 0, s = o.length;
            s > c;
            ++c, i = null
          )
        ...
        function f() {
          if (Go.event.touches.length) {
            for (
              var t = Go.event.changedTouches, e = 0, r = t.length;
              r > e;
              ++e
            )
      ...
      function g() {
        ...
        o(n),
          r(
            Math.pow(
              2,
              Go.event.shiftKey ? Math.ceil(s) - 1 : Math.floor(s) + 1
            )
          ),
          u(e, i),
          a(n),
  ...
  (Oa.brighter = function(n) {
    return (
      ...
      rt(this.h, this.s, this.l / n)
    );
  }),
    (Oa.darker = function(n) {
      return (
        (n = Math.pow(0.7, arguments.length ? n : 1)),
        rt(this.h, this.s, n * this.l)
      );
    }),
    (Oa.rgb = function() {
    ...
    (Go.hcl = function(n, t, e) {
      return 1 === arguments.length
        ? n instanceof at
          ...
          : n instanceof lt
          ? ht(n.l, n.a, n.b)
          : ht((n = wt((n = Go.rgb(n)).r, n.g, n.b)).l, n.a, n.b)
        : ot(+n, +t, +e);
    });
  ...
  (Ia.brighter = function(n) {
    return ot(
      this.h,
      this.c,
      Math.min(100, this.l + Ya * (arguments.length ? n : 1))
    );
  }),
    (Ia.darker = function(n) {
      return ot(
        this.h,
        this.c,
        Math.max(0, this.l - Ya * (arguments.length ? n : 1))
      );
    }),
    (Ia.rgb = function() {
  ...
  Ja.forEach(function(n, t) {
    ...
    (Go.csv = Go.dsv(",", "text/csv")),
    (Go.tsv = Go.dsv("	", "text/tab-separated-values")),
    (Go.touch = function(n, t, e) {
  ...
  (Go.timer = function(n, t, e) {
    ...
    Ga ? (Ga.n = i) : (Wa = i),
      (Ga = i),
      Ka || ((Qa = clearTimeout(Qa)), (Ka = 1), tc(Tt));
  }),
  ...
  var rc = /(?:([^{])?([<>=^]))?([+\- ])?([$#])?(0)?(\d+)?(,)?(\.-?\d+)?([a-z%])?/i,
    uc = Go.map({
      ...
      r: function(n, t) {
        return (n = Go.round(n, Rt(n, t))).toFixed(
          Math.max(0, Math.min(20, Rt(n * (1 + 1e-15), t)))
        );
      }
    }),
    ic = (Go.time = {}),
  ...
  (ic.year = Ht(
    ...
    (ic.years = ic.year.range),
    (ic.years.utc = ic.year.utc.range),
    (ic.day = Ht(
      function(n) {
        var t = new oc(2e3, 0);
    ...
    (ic.days = ic.day.range),
    (ic.days.utc = ic.day.utc.range),
    (ic.dayOfYear = function(n) {
      var t = ic.year(n);
      return Math.floor(
    ...
    [
      ...
      var e = (ic[n] = Ht(
        function(n) {
          return (
            (n = ic.day(n)).setDate(n.getDate() - ((n.getDay() + t) % 7)), n
          );
        },
        function(n, t) {
      ...
      (ic[n + "s"] = e.range),
        (ic[n + "s"].utc = e.utc.range),
        (ic[n + "OfYear"] = function(n) {
          var e = ic.year(n).getDay();
          return Math.floor((ic.dayOfYear(n) + ((e + t) % 7)) / 7);
        });
    }),
    (ic.week = ic.sunday),
    (ic.weeks = ic.sunday.range),
    (ic.weeks.utc = ic.sunday.utc.range),
  ...
  var vc,
    ...
    mc = {
      ...
      polygonEnd: function() {
        var n = 2 * dc;
        (vc += 0 > n ? 4 * Aa + n : n),
          (mc.lineStart = mc.lineEnd = mc.point = v);
      }
    };
  (Go.geo.bounds = (function() {
    ...
    (Go.geo.centroid = function(n) {
      (yc = xc = Mc = _c = bc = wc = Sc = kc = Ec = Nc = Ac = 0),
        Go.geo.stream(n, Cc);
      var t = Ec,
        e = Nc,
        r = Ac,
      ...
      return qa > u &&
        ...
        (e = Sc),
        (r = kc),
        Ta > xc && ((t = Mc), (e = _c), (r = bc)),
        (u = t * t + e * e + r * r),
        qa > u)
        ? [0 / 0, 0 / 0]
        : [Math.atan2(e, t) * Ra, G(r / Math.sqrt(u)) * Ra];
    });
  var yc,
    xc,
    Mc,
        ...
        (n.translate = function(t) {
          ...
          return (
            ...
            (r = o
              ...
              .clipExtent([
                [l - 0.425 * s + Ta, f + 0.12 * s + Ta],
                [l - 0.214 * s - Ta, f + 0.234 * s - Ta]
              ])
              .stream(c).point),
            (u = a
              .translate([l - 0.205 * s, f + 0.212 * s])
              .clipExtent([
                [l - 0.214 * s + Ta, f + 0.166 * s + Ta],
                [l - 0.115 * s - Ta, f + 0.234 * s - Ta]
              ])
              .stream(c).point),
            n
          );
  ...
  (Go.geo.path = function() {
    ...
    return (
      ...
      (n.centroid = function(n) {
        return (
          (Mc = _c = bc = wc = Sc = kc = Ec = Nc = Ac = 0),
          Go.geo.stream(n, u(Fc)),
          Ac
            ? [Ec / Ac, Nc / Ac]
            : kc
            ? [wc / kc, Sc / kc]
      ...
      (n.bounds = function(n) {
        return (
          (Pc = Uc = -(Rc = Dc = 1 / 0)),
          Go.geo.stream(n, u(Hc)),
          [[Rc, Dc], [Pc, Uc]]
        );
      }),
      (n.projection = function(n) {
        return arguments.length
          ? ((u = (e = n) ? n.stream || tr(n) : Nt), t())
          : e;
      }),
      (n.context = function(n) {
        return arguments.length
          ? ((i = null == (r = n) ? new Xe() : new Qe(n)),
    ...
    (Go.geo.projection = ur),
    (Go.geo.projectionMutator = ir),
    ((Go.geo.equirectangular = function() {
      return ur(ar);
    }).raw = ar.invert = ar),
    (Go.geo.rotation = function(n) {
      function t(t) {
        return (t = n(t[0] * za, t[1] * za)), (t[0] *= Ra), (t[1] *= Ra), t;
      }
      return (
        (n = sr((n[0] % 360) * za, n[1] * za, n.length > 2 ? n[2] * za : 0)),
        (t.invert = function(t) {
          return (
            (t = n.invert(t[0] * za, t[1] * za)), (t[0] *= Ra), (t[1] *= Ra), t
          );
        }),
        t
      );
    ...
    (Go.geo.graticule = function() {
      ...
      function t() {
        return Go.range(Math.ceil(i / d) * d, u, d)
          .map(h)
          .concat(Go.range(Math.ceil(s / m) * m, c, m).map(g))
          .concat(
            Go.range(Math.ceil(r / p) * p, e, p)
              .filter(function(n) {
                return fa(n % d) > Ta;
              })
              .map(l)
      ...
      return (
        ...
        n
          .majorExtent([[-180, -90 + Ta], [180, 90 - Ta]])
          .minorExtent([[-180, -80 - Ta], [180, 80 + Ta]])
      );
    }),
  ...
  ((Go.geo.azimuthalEquidistant = function() {
    ...
    ((Go.geo.conicConformal = function() {
      return Ye(br);
    }).raw = br),
    ((Go.geo.conicEquidistant = function() {
      return Ye(wr);
    }).raw = wr);
    ...
    (Bc.clip = function(n) {
      for (
        ...
        for (
          ...
          (o = t[e]),
            Tr(o, l, u)
              ? (Tr(i, l, u) || n.push(qr(i, o, l, u)), n.push(o))
              : Tr(i, l, u) && n.push(qr(i, o, l, u)),
            (i = o);
        a && n.push(n[0]), (l = u);
      }
      return n;
        ...
        if (
          ...
          do {
            ...
            if (n === u.L) {
              if (
                ((t = u.R),
                t.C && ((t.C = !1), (u.C = !0), eu(this, u), (t = u.R)),
                (t.L && t.L.C) || (t.R && t.R.C))
              ) {
                (t.R && t.R.C) ||
                  ((t.L.C = !1), (t.C = !0), ru(this, t), (t = u.R)),
                  (t.C = u.C),
                  (u.C = t.R.C = !1),
                  eu(this, u),
                  (n = this._);
              ...
              ((t = u.L),
              t.C && ((t.C = !1), (u.C = !0), ru(this, u), (t = u.L)),
              (t.L && t.L.C) || (t.R && t.R.C))
            ) {
              (t.L && t.L.C) ||
                ((t.R.C = !1), (t.C = !0), eu(this, t), (t = u.L)),
                (t.C = u.C),
                (u.C = t.L.C = !1),
                ru(this, u),
                (n = this._);
  ...
  (Go.geom.delaunay = function(n) {
    ...
    (Go.geom.quadtree = function(n, t, e, r, u) {
          ...
          if (!isNaN(e) && !isNaN(r))
            if (n.leaf) {
              var c = n.x,
                l = n.y;
              if (null != c)
                if (fa(c - e) + fa(l - r) < 0.01) s(n, t, e, r, u, i, o, a);
                else {
                  var f = n.point;
      ...
      return (o = arguments.length)
        ? ((a = cu), (c = su), 3 === o && ((u = e), (r = t), (e = t = 0)), i(n))
        : ((i.x = function(n) {
    ...
    (Go.interpolateRgb = hu),
    (Go.interpolateObject = gu),
    (Go.interpolateNumber = pu),
    (Go.interpolateString = vu);
  var rs = /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g,
  ...
  (Go.ease = function(n) {
    ...
    return (
      (e = os.get(e) || is),
      (r = as.get(r) || Nt),
      yu(r(e.apply(null, Ko.call(arguments, 1))))
    );
  }),
    (Go.interpolateHcl = Tu),
    (Go.interpolateHsl = qu),
    (Go.interpolateLab = zu),
    (Go.interpolateRound = Ru),
    (Go.transform = function(n) {
  ...
  (Go.interpolateTransform = Hu),
    (Go.layout = {}),
    (Go.layout.bundle = function() {
      return function(n) {
  ...
  Go.layout.stack = function() {
    ...
    return (
      ...
      (n.order = function(t) {
        return arguments.length
          ? ((e = "function" == typeof t ? t : gs.get(t) || ui), n)
          : e;
      }),
      (n.offset = function(t) {
        return arguments.length
          ? ((r = "function" == typeof t ? t : ps.get(t) || ii), n)
          : r;
      }),
      (n.x = function(t) {
      ...
      if (g > 0)
        for (i = -1; ++i < h; )
          (a = s[i]),
            a >= l[0] &&
              a <= l[1] &&
              ((o = c[Go.bisect(f, a, 1, g) - 1]), (o.y += p), o.push(n[i]));
      return c;
    }
    var t = !0,
      e = Number,
          ...
          if (t) {
            for (
              ...
              (c = gi(c)),
                ...
                u > 0 && (_i(bi(a, n, r), n, u), (s += u), (l += u)),
                (f += a._tree.mod),
                (s += i._tree.mod),
                (h += c._tree.mod),
                (l += o._tree.mod);
            a && !pi(o) && ((o._tree.thread = a), (o._tree.mod += f - l)),
              i &&
                !gi(c) &&
      ...
      return (
        ...
        (i.padding = function(n) {
          function t(t) {
            ...
            return null == e
              ? Pi(t)
              : Ui(t, "number" == typeof e ? [e, e, e, e] : e);
          }
          function e(t) {
            return Ui(t, n);
          }
  ...
  (Rs.call = _a.call),
    ...
    (Rs.node = _a.node),
    (Rs.size = _a.size),
    (Go.transition = function(n) {
      return arguments.length ? (Ls ? n.transition() : n) : Sa.transition();
    }),
    (Go.transition.prototype = Rs),
    (Rs.select = function(n) {
      var t,
        e,
        r,
        u = this.id,
      ...
      function u(t) {
        return null == t
          ...
          : ((t += ""),
            function() {
              var r,
                u = ea.getComputedStyle(this, null).getPropertyValue(n);
              return (
                u !== t &&
                ((r = du(u, t)),
                function(t) {
    ...
    (Rs.styleTween = function(n, t, e) {
      function r(r, u) {
        var i = t.call(
          ...
          r,
          u,
          ea.getComputedStyle(this, null).getPropertyValue(n)
        );
        return (
          i &&
          function(t) {
    ...
    (Rs.ease = function(n) {
      ...
      return arguments.length < 1
        ...
        : ("function" != typeof n && (n = Go.ease.apply(Go, arguments)),
          P(this, function(e) {
    ...
    (Rs.transition = function() {
      for (
        var n, t, e, r, u = this.id, i = ++Ds, o = [], a = 0, c = this.length;
        c > a;
        a++
      ) {
        o.push((n = []));
  ...
  Go.svg.brush = function() {
    function n(i) {
      i.each(function() {
        ...
        var l,
          f = Go.transition(i),
          h = Go.transition(o);
        c && ((l = Hi(c)), h.attr("x", l[0]).attr("width", l[1] - l[0]), e(f)),
          s &&
            ((l = Hi(s)), h.attr("y", l[0]).attr("height", l[1] - l[0]), r(f)),
          t(f);
      });
    }
    function t(n) {
    ...
    function u() {
      function u() {
        32 == Go.event.keyCode &&
          (A || ((x = null), (L[0] -= l[1]), (L[1] -= f[1]), (A = 2)), y());
      }
      function p() {
        32 == Go.event.keyCode &&
          2 == A &&
          ((L[0] += l[1]), (L[1] += f[1]), (A = 0), y());
      }
      function v() {
        var n = Go.mouse(_),
          u = !1;
        M && ((n[0] += M[0]), (n[1] += M[1])),
          ...
          E && d(n, c, 0) && (e(S), (u = !0)),
          N && d(n, s, 1) && (r(S), (u = !0)),
          u && (t(S), w({ type: "brush", mode: A ? "move" : "resize" }));
      }
      function d(n, t, e) {
        var r,
          u,
      ...
      function m() {
        v(),
          ...
          Go.select("body").style("cursor", null),
      ...
      var x,
        ...
        T = Go.select(ea)
          ...
          .on("keyup.brush", p);
      if (
        (Go.event.changedTouches
          ? T.on("touchmove.brush", v).on("touchend.brush", m)
          : T.on("mousemove.brush", v).on("mouseup.brush", m),
        S.interrupt()
          .selectAll("*")
          .interrupt(),
        A)
      ...
      S.style("pointer-events", "none")
        .selectAll(".resize")
        .style("display", null),
        Go.select("body").style("cursor", b.style("cursor")),
        w({ type: "brushstart" }),
        v();
    }
    var i,
  ...
  (Fs.iso =
    ...
    (ic.seconds = ic.second.range),
    (ic.seconds.utc = ic.second.utc.range),
    (ic.minute = Ht(
      function(n) {
    ...
    (ic.minutes = ic.minute.range),
    (ic.minutes.utc = ic.minute.utc.range),
    (ic.hour = Ht(
      function(n) {
    ...
    (ic.hours = ic.hour.range),
    (ic.hours.utc = ic.hour.utc.range),
    (ic.month = Ht(
      function(n) {
    ...
    (ic.months = ic.month.range),
    (ic.months.utc = ic.month.utc.range);
  var Ys = [
      1e3,
      5e3,
      15e3,
